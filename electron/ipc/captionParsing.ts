...
export function buildCaptionTextFromWords(words: CaptionWordPayload[]) {
  return words
...
export function parseWhisperJsonWords(tokens: unknown) {
...
export function parseWhisperJsonCues(content: string) {
  try {
...
export function parseSrtCues(content: string) {
  return content
    .split(/\r?\n\r?\n/)
    .map((block, index) => {
...
export function shouldRetryWhisperWithoutJson(error: unknown) {
